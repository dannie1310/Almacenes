 ...
 */
 class DBScaSqlite extends SQLiteOpenHelper {
    ...
    private static String[] queries = new String[] {
            ...
            "CREATE TABLE entrada (ID INTEGER PRIMARY KEY AUTOINCREMENT,  idorden TEXT, idmaterial TEXT, referencia TEXT, observacion TEXT, fecha VARCHAR(8), idobra INTEGER, folio TEXT, numerofolio INTEGER)",
